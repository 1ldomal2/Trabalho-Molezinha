...
void Ler_Hotel_Txt();
void Gravar_Hotel_Txt(DADOS_HOTEL *Hotel);
void Ler_Hotel_Bin();
void Gravar_Hotel_Bin(DADOS_HOTEL *Hotel);
void Criar_Editar_Hotel(int Modo_de_Abertura);
int Manipular_Arquivo();
...
void Quick_Sort(int vetor[], int inicio, int fim){
   //Algoritmo Auxiliar para a Ordenação de um Rol;
	...
	void Criar_Editar_Hotel(int Modo_de_Abertura){
		...
		switch (Modo_de_Abertura){
			case Memoria:
				...
				break;
			case Arquivo_Texto:
				Hotel.Codigo = Valida_Codigo("Hotel.txt",15,Arquivo_Texto);
				break;
			case Arquivo_Binario:
				Hotel.Codigo = Valida_Codigo("Hotel.bin",15,Arquivo_Binario);
		...
		*/
		switch(Modo_de_Abertura){
			...
			case Arquivo_Texto:
				Gravar_Hotel_Txt(&Hotel);
				break;

			case Arquivo_Binario:
				Gravar_Hotel_Bin(&Hotel);
				break;
